                ...
                <div class="col-lg-6">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form
                                action="@if ($model->exists) {{ route('petugas.update', $model->id) }} @else {{ route('petugas.store') }} @endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid" name="nama_petugas" type="text"
                                        placeholder="nama_petugas"
                                        value="{{ old('nama_petugas', $model->nama_petugas) }}" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid" name="alamat" type="text"
                                        placeholder="alamat" value="{{ old('alamat', $model->alamat) }}" />
                                </div>
                                @if (!$model->exists)
                                    <div class="form-group">
                                        <label class="small mb-1">password</label>
                                        <input class="form-control form-control-solid" name="password" type="password"
                                            placeholder="password" value="{{ old('password', $model->password) }}" />
                                    </div>
                                @endif
                                <div class="form-group">
